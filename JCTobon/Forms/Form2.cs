...
namespace JCTobon.Forms
{
    public partial class Form2 : Form
    {
        ...
        private Form111 form111;
        private void button2_Click(object sender, EventArgs e)
        {
            //abrirPanel(new Form111());
            if (form111 == null || form111.IsDisposed) // Verificar si el formulario no está abierto o ya ha sido cerrado
            {
                form111 = new Form111(); // Crear una nueva instancia solo si no existe o está cerrado
                form111.Show();
            }
            else
            {
                form111.Focus(); // Enfocar y traer al frente el formulario existente
            }
