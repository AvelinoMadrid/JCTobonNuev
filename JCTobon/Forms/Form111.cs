...
namespace JCTobon.Forms
{
    public partial class Form111 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pd.PrintPage += new PrintPageEventHandler(this.ImprimirTicket_PrintPage);
            pd.Print();
            ...
            SqlCommand guardar = new SqlCommand("INSERT INTO Ventas(Tipo, Nombre, Talla, PrecioVenta, CantidadPiezas, Existencia, Total,Folio,Marca,IdCodigoBarra,UtilidadEscuela,Fecha,utilidadjctobon) Values (@Tipo, @Nombre, @Talla, @PrecioVenta, @CantidadPiezas, @Existencia, @Total,@Folio,@Marca,@IdCodigoBarra,@Utilidad,@Fecha,@utilidadjctobon)", con);
            con.Open();
        ...
        {
            // Obtener el PictureBox con el código de barras
            PictureBox pb = pictureBox13;

            // Obtener la posición y tamaño del PictureBox
            ...
            // Imprimir el PictureBox
            e.Graphics.DrawImage(pb.Image, x, x, x, y);
        }
        ...
        private void txtCodigoBarra_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                String sql = "Select Tipo, Nombre, Talla, PrecioVenta,Existencia,Marca,UtilidadEscuela,UtilidadJCTobon from Productos where CodigoBarra ='" + txtCodigoBarra.Text + "'";
                con.Open();
        ...
        public void GeneraCodigo()
        {
            ...
            string folioventa = txtfolio.Text;
            ...
            Image imgBarcode = barcode.Encode(TYPE.CODE128, folioventa);

            pictureBox13.Image = imgBarcode;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int existencia = int.Parse(txtExistencia.Text);
            int compra = int.Parse(txtCantidad.Text);

            if(compra > existencia)
            {
                MessageBox.Show("No se puede realizar la compra; por favor verificar el Stock");
                limpiar();
            }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("**********************************", font, Brushes.Black, new RectangleF(0, posy, ancho, 20));
            posy += 15;
            e.Graphics.DrawString("  Nombre  " + " Talla " + "   Cantidad  " + "   Precio  " + "   Subtotal  ", font, Brushes.Black, new RectangleF(0, posy, ancho, 30));
            ...
            foreach (DataGridViewRow r in dataGridView1.Rows)
            {
                ...
                posy += 15;
                e.Graphics.DrawString(r.Cells[3].Value.ToString() + "    " + (r.Cells[4].Value.ToString()) + "    " + double.Parse(r.Cells[6].Value.ToString()) + "    " +  int.Parse(r.Cells[5].Value.ToString()) + "    " + double.Parse(r.Cells[8].Value.ToString()), font, Brushes.Black, new RectangleF(0, posy, ancho, 30));
        ...
        private void txtCodigoBarra_CursorChanged(object sender, EventArgs e)
        {
