...
namespace JCTobon.Forms
{
    public partial class Form16 : Form
    {
        ...
        public void muestraCodigo(string codigo,string nombre,string talla)
        {
            ...
            label3.Text= nombre ;
            label4.Text = talla;
            panel3.BackgroundImage = Codigo.Encode(BarcodeLib.TYPE.CODE39, codigo, Color.Black, Color.White, 170, 50); /*agregamos el codigo de barras, el tipo, color de fondo, ancho y alto*/
        ...
        private void Imprimir(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(panel3.BackgroundImage, 20, 40, 135, 35); // codigo barra

            //e.Graphics.DrawImage(panel3.BackgroundImage, 30, 40, 130, 35); // codigo barra bueno 

            e.Graphics.DrawString(label3.Text, font, Brushes.Black, 105, 90, Format); // nombre producto
            //e.Graphics.DrawString(name, font, Brushes.Black, 50, 55);

            e.Graphics.DrawString(label4.Text, font, Brushes.Black, 105, 102, Format); // talla
        }
